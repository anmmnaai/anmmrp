...
import anmmrp
from anmmrp import api, fields, models, tools, _
from anmmrp.exceptions import ValidationError, AccessError, UserError
from anmmrp.http import request
from anmmrp.modules.module import get_resource_from_path
from anmmrp.tools import config, ConstantMapping, get_diff, pycompat, apply_inheritance_specs, locate_node, str2bool
from anmmrp.tools import safe_eval, lazy, lazy_property, frozendict
from anmmrp.tools.convert import _fix_multiple_roots
from anmmrp.tools.misc import file_path
from anmmrp.tools.translate import xml_translate, TRANSLATED_ATTRS
from anmmrp.tools.view_validation import valid_view, get_domain_value_names, get_expression_field_names, get_dict_asts
from anmmrp.models import check_method_name
from anmmrp.osv.expression import expression
...
@lazy
def keep_query():
    mod = anmmrp.addons.base.models.ir_qweb
