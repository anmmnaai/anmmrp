...
import anmmrp
from anmmrp import api, fields, models, modules, tools, _
from anmmrp.addons.base.models.ir_model import MODULE_UNINSTALL_FLAG
from anmmrp.exceptions import AccessDenied, UserError, ValidationError
from anmmrp.osv import expression
from anmmrp.tools.parse_version import parse_version
from anmmrp.tools.misc import topological_sort, get_flag
from anmmrp.tools.translate import TranslationImporter, get_po_paths
from anmmrp.http import request
from anmmrp.modules import get_module_path
...
class Module(models.Model):
                ...
                with tools.file_open(path, 'rb') as desc_file:
                    ...
                    if doc.startswith(XML_DECLARATION):
                        warnings.warn(
                            ...
                            f"deprecated since anmMRP 17, {module.name} can just "
                        ...
                        try:
                            ...
                            warnings.warn(
                                ...
                                f"since anmMRP 17 ({module.name}'s description "
                                f"is not utf-8)",
                                category=DeprecationWarning,
                            )
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'anmMRP Enterprise Edition License v1.0'),
        ('OPL-1', 'anmMRP Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('anmMRP Enterprise Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        try:
            ...
            raise UserError(_("anmMRP is currently processing a scheduled action.\n"
    ...
    def button_uninstall(self):
        un_installable_modules = set(anmmrp.conf.server_wide_modules) & set(self.mapped('name'))
