...
"""The anmMRP API module defines anmMRP Environments and method decorators.
...
def constrains(*args):
    ...
    Should raise :exc:`~anmmrp.exceptions.ValidationError` if the
    validation failed.
...
def ondelete(*, at_uninstall):
    """
    Mark a method to be executed during :meth:`~anmmrp.models.BaseModel.unlink`.
...
def onchange(*args):
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/anmmrp/anmmrp/issues/2693>`_.
...
class Environment(Mapping):
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        ...
        :type cursor: :class:`~anmmrp.sql_db.Cursor`
    ...
    def user(self):
        ...
        :rtype: :class:`res.users record<~anmmrp.addons.base.models.res_users.Users>`"""
    ...
    def company(self):
        ...
        :rtype: :class:`res.company record<~anmmrp.addons.base.models.res_company.Company>`
    ...
    def companies(self):
        ...
        :rtype: :class:`res.company recordset<~anmmrp.addons.base.models.res_company.Company>`
