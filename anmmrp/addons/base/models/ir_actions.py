...
import anmmrp
from anmmrp import api, fields, models, tools, _, Command
from anmmrp.exceptions import MissingError, ValidationError, AccessError, UserError
from anmmrp.tools import frozendict
from anmmrp.tools.safe_eval import safe_eval, test_python_expr
from anmmrp.tools.float_utils import float_compare
...
class IrActionsServer(models.Model):
    ...
    Since anmMRP 8.0 a button 'Create Menu Action' button is available on the
...
# To return an action, assign: action = {...}\n\n\n\n"""
    ...
    def _get_eval_context(self, action=None):
        ...
        eval_context.update({
            ...
            'model': model,
            # Exceptions
            'UserError': anmmrp.exceptions.UserError,
            # record
            'record': record,
            'records': records,
            # helpers
