...
from anmmrp.exceptions import AccessError, ValidationError
...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - anmmrp/addons/test_access_rights/tests/test_feedback.py
        # - anmmrp/addons/test_access_rights/tests/test_ir_rules.py
        # - anmmrp/addons/base/tests/test_orm.py (/home/dle/src/anmmrp/master-nochange-fp/anmmrp/addons/base/tests/test_orm.py)
        self.env.flush_all()
        self.env.registry.clear_cache()
        return res
    ...
    def _make_access_error(self, operation, records):
        ...
        if company_related:
            failing_rules += "\n\n" + _('Note: this might be a multi-company issue. Switching company may help - in anmMRP, not in real life!')
