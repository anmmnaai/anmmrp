...
from anmmrp.exceptions import RedirectWarning, UserError, ValidationError
...
class Partner(models.Model):
    ...
    def _compute_email_formatted(self):
        ...
        for partner in self:
            ...
            if emails_normalized:
                ...
                # but this is current behavior in anmMRP 14+ and some servers allow it
    ...
    def write(self, vals):
        if vals.get('active') is False:
            ...
            # https://github.com/anmmrp/anmmrp/commit/9d7226371730e73c296bcc68eb1f856f82b0b4ed
            #
