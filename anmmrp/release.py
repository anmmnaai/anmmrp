...
product_name = 'anmMRP'
description = 'anmMRP Server'
long_desc = '''anmMRP is a complete ERP and CRM. The main features are accounting (analytic
...
"""
url = 'https://www.anmmna.com'
author = 'OpenERP S.A.'
author_email = 'info@anmmna.com'
license = 'LGPL-3'

nt_service_name = "anmmna-server-" + series.replace('~','-')
