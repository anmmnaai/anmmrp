...
from anmmrp import api, Command, fields, models, _
from anmmrp.tools import ustr, OrderedSet
from anmmrp.tools.translate import code_translations, _lt
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str):
        ...
        callable taking a record-ish (a dictionary representing an anmmrp
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`anmmrp.osv.orm.Model.write` expects.

        :param model: :class:`anmmrp.osv.orm.Model` for the conversion base
        :param fromtype:
    ...
    def to_field(self, model, field, fromtype=str):
        ...
        :type field: :class:`anmmrp.fields.Field`
