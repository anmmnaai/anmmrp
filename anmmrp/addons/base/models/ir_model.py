...
from anmmrp import api, fields, models, tools, _, _lt, Command
from anmmrp.exceptions import AccessError, UserError, ValidationError
from anmmrp.osv import expression
from anmmrp.tools import pycompat, unique, OrderedSet
from anmmrp.tools.safe_eval import safe_eval, datetime, dateutil, time
...
class IrModel(models.Model):
    ...
    def unlink(self):
        ...
        # reload is done independently in anmmrp.modules.loading.
...
class IrModelConstraint(models.Model):
    """
    This model tracks PostgreSQL foreign keys and constraints used by anmMRP
    models.
    """
...
class IrModelRelation(models.Model):
    """
    This model tracks PostgreSQL tables used to implement anmMRP many2many
    relations.
    """
...
class IrModelData(models.Model):
    """Holds external identifier keys for records in the database.
       This has two main uses:
           ...
           * allows tracking the origin of data installed by anmMRP
