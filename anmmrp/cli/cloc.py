...
from anmmrp.tools import cloc, config
from . import Command
...
class Cloc(Command):
    ...
    def run(self, args):
        parser = argparse.ArgumentParser(
            ...
            description="""\
anmMRP cloc is a tool to count the number of relevant lines written in
...
It has two modes of operation, either by providing a path:
    ...
    anmmrp-bin cloc -p module_path

Or by providing the name of a database:

    anmmrp-bin cloc --addons-path=dirs -d database
