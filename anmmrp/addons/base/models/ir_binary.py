...
from anmmrp.exceptions import MissingError, UserError
from anmmrp.http import Stream, request
from anmmrp.tools import file_open, replace_exceptions
from anmmrp.tools.image import image_process, image_guess_size_from_field_name
from anmmrp.tools.mimetypes import guess_mimetype, get_extension
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:anmmrp.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~anmmrp.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`anmmrp.tools.image.image_process`.
