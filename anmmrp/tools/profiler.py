...
class SyncCollector(Collector):
    ...
    Note that --limit-memory-hard may need to be increased when launching anmMRP.
    """
    name = 'traces_sync'
    ...
    def __exit__(self, *args):
        try:
            ...
            if self.db:
                ...
                from anmmrp.sql_db import db_connect  # only import from anmmrp if/when needed.
