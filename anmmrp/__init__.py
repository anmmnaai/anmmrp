...
#----------------------------------------------------------
# anmmrp must be a namespace package for anmmrp.addons to become one too
...
import sys
assert sys.version_info > (3, 10), "Outdated python version detected, anmmrp requires Python >= 3.10 to run."
...
from . import fields
from . import api
from anmmrp.tools.translate import _, _lt
