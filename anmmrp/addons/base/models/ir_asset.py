...
import anmmrp
import anmmrp.modules.module  # get_manifest, don't from-import it
from anmmrp import api, fields, models, tools
from anmmrp.tools import misc
from anmmrp.tools.constants import ASSET_EXTENSIONS, EXTERNAL_ASSET
...
class IrAsset(models.Model):
    ...
    def _fill_asset_paths(self, bundle, asset_paths, seen, addons, installed, **assets_params):
        ...
        for addon in addons:
            for command in anmmrp.modules.module._get_manifest_cached(addon)['assets'].get(bundle, ()):
    ...
    def _topological_sort(self, addons_tuple):
        ...
        def mapper(addon):
            manif = anmmrp.modules.module._get_manifest_cached(addon)
    ...
    def _get_installed_addons_list(self):
        ...
        return self.env.registry._init_modules.union(anmmrp.conf.server_wide_modules or [])
    ...
    def _get_paths(self, path_def, installed):
        ...
        Ex: ('/base/static/file.js', '/home/user/source/anmmrp/anmmrp/addons/base/static/file.js', 643636800)
        ...
        addon = path_parts[0]
        addon_manifest = anmmrp.modules.module._get_manifest_cached(addon)
