        ...
        try:
            ...
            for model in ordered_models:
                if profiling_enabled:
                    profiling_context = anmmrp.tools.profiler.Profiler(
                ...
                if commit:
                    ...
                    commit_context = patch('anmmrp.sql_db.Cursor.commit')
