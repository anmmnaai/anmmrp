...
from anmmrp import api, fields, models, tools, SUPERUSER_ID, _
from anmmrp.exceptions import UserError, AccessError
from anmmrp.tools.safe_eval import safe_eval, time
from anmmrp.tools.misc import find_in_path, ustr
from anmmrp.tools import check_barcode_encoding, config, is_html_empty, parse_version, split_every
from anmmrp.http import request
from anmmrp.osv.expression import NEGATIVE_TERM_OPERATORS, FALSE_DOMAIN
...
# here to init the T1 fonts cache at the start-up of anmMRP so that rendering of barcode in multiple
...
# Check the presence of Wkhtmltopdf and return its version at anmMRP start-up
...
try:
    ...
    if match:
        ...
        if config['workers'] == 1:
            _logger.info('You need to start anmMRP with at least two workers to print a pdf version of the reports.')
    ...
    def _merge_pdfs(self, streams):
        ...
        for stream in streams:
            try:
                ...
                raise UserError(_("anmMRP is unable to merge the generated PDFs."))
