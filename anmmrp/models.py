    ...
    def __new__(meta, name, bases, attrs):
        ...
        if attrs.get('_register', True):
            ...
            if '_module' not in attrs:
                ...
                assert module.startswith('anmmrp.addons.'), \
                    f"Invalid import of {module}.{name}, it should start with 'anmmrp.addons'."
...
class BaseModel(metaclass=MetaModel):
    """Base class for anmMRP models.

    anmMRP models are created by inheriting one of the following:
    ...
    *   :class:`AbstractModel` for abstract super classes meant to be shared by
    ...
    the :attr:`~anmmrp.models.BaseModel._register` attribute may be set to False.
    """
    __slots__ = ['env', '_ids', '_prefetch_ids']

    _auto = False
    """Whether a database table should be created.
    If set to ``False``, override :meth:`~anmmrp.models.BaseModel.init`
    ...
    .. tip:: To create a model without any table, inherit
            from :class:`~anmmrp.models.AbstractModel`.
    """
    ...
    _module = None              #: the model's module (in the anmMRP sense)
    ...
    .. warning::
      ...
      :attr:`~anmmrp.models.Model._inherits`-ed models, the inherited field will
    ...
    def load(self, fields, data):
        ...
        for field_path in fields:
            ...
            if isinstance(model_fields[field_path[0]], anmmrp.fields.Many2one):
            ...
            for field_name in field_path:
                ...
                if isinstance(model_fields[field_name], anmmrp.fields.One2many):
    ...
    def _add_fake_fields(self, fields):
        from anmmrp.fields import Char, Integer
    ...
    def _compute_display_name(self):
        ...
        it can be made field-dependent using :attr:`~anmmrp.api.depends` and
        context-dependent using :attr:`~anmmrp.api.depends_context`.
        """
        if self._rec_name:
    ...
    def _read_group_fill_temporal(self, data, groupby, annoted_aggregates,
        ...
        if fill_from:
            fill_from = anmmrp.fields.Datetime.to_datetime(fill_from) if isinstance(fill_from, datetime.datetime) else anmmrp.fields.Date.to_date(fill_from)
        ...
        if fill_to:
            fill_to = anmmrp.fields.Datetime.to_datetime(fill_to) if isinstance(fill_to, datetime.datetime) else anmmrp.fields.Date.to_date(fill_to)
    ...
    def _check_company(self, fnames=None):
        ...
        :raises UserError: if the `company_id` of the value of any field is not
            ...
            :class:`~anmmrp.addons.base.models.res_company`).

        For :class:`~anmmrp.addons.base.models.res_users` relational fields,
    ...
    def unlink(self):
        ...
        from anmmrp.addons.base.models.ir_model import MODULE_UNINSTALL_FLAG
    ...
    def write(self, vals):
        ...
        * For numeric fields (:class:`~anmmrp.fields.Integer`,
          :class:`~anmmrp.fields.Float`) the value should be of the
          corresponding type
        * For :class:`~anmmrp.fields.Boolean`, the value should be a
          :class:`python:bool`
        * For :class:`~anmmrp.fields.Selection`, the value should match the
          selection values (generally :class:`python:str`, sometimes
          :class:`python:int`)
        * For :class:`~anmmrp.fields.Many2one`, the value should be the
          database identifier of the record to set
        * The expected value of a :class:`~anmmrp.fields.One2many` or
          :class:`~anmmrp.fields.Many2many` relational field is a list of
          :class:`~anmmrp.fields.Command` that manipulate the relation the
          implement. There are a total of 7 commands:
          :meth:`~anmmrp.fields.Command.create`,
          :meth:`~anmmrp.fields.Command.update`,
          :meth:`~anmmrp.fields.Command.delete`,
          :meth:`~anmmrp.fields.Command.unlink`,
          :meth:`~anmmrp.fields.Command.link`,
          :meth:`~anmmrp.fields.Command.clear`, and
          :meth:`~anmmrp.fields.Command.set`.
        * For :class:`~anmmrp.fields.Date` and `~anmmrp.fields.Datetime`,
          ...
          .. warning::
            ...
            :const:`anmmrp.tools.misc.DEFAULT_SERVER_DATE_FORMAT` and
            :const:`anmmrp.tools.misc.DEFAULT_SERVER_DATETIME_FORMAT`
    ...
    def ensure_one(self):
        ...
        :raise anmmrp.exceptions.ValueError: ``len(self) != 1``
        """
        try:
    ...
    def with_env(self, env):
        ...
        :param env:
        :type env: :class:`~anmmrp.api.Environment`
    ...
    def with_company(self, company):
        ...
        :type company: :class:`~anmmrp.addons.base.models.res_company` or int
    ...
    def _populate_factories(self):
        ...
        See :mod:`anmmrp.tools.populate` for population tools and applications.
...
class Model(AbstractModel):
    """ Main super-class for regular database-persisted anmMRP models.

    anmMRP models are created by inheriting from this class::
