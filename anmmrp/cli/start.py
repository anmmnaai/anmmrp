...
from anmmrp.modules.module import get_module_root, MANIFEST_NAMES
from anmmrp.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """ Quickly start the anmmrp server with default options """
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            anmmrp.tools.config['init']['base'] = True
