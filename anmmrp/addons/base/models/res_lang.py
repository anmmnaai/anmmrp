...
class Lang(models.Model):
    ...
    def install_lang(self):
        ...
        This method is called from anmmrp/addons/base/data/res_lang_data.xml to load
    ...
    def write(self, vals):
        ...
        if vals.get('active') == False:
            ...
            if self.env['res.users'].with_context(active_test=False).search_count([('lang', 'in', lang_codes)], limit=1):
                raise UserError(_("You cannot archive the language in which anmMRP was setup as it is used by automated processes."))
