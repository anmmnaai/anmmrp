...
import anmmrp
from anmmrp import api, http, models, tools, SUPERUSER_ID
from anmmrp.exceptions import AccessDenied, AccessError, MissingError
from anmmrp.http import request, Response, ROUTING_KEYS, Stream
from anmmrp.modules.registry import Registry
from anmmrp.service import security
from anmmrp.tools import get_lang, submap
from anmmrp.tools.translate import code_translations
...
class IrHttp(models.AbstractModel):
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        for key, val in list(args.items()):
            ...
            try:
            ...
            except (anmmrp.exceptions.AccessError, anmmrp.exceptions.MissingError) as e:
                ...
                if isinstance(e, anmmrp.exceptions.MissingError):
    ...
    def routing_map(self, key=None):
        ...
        installed = registry._init_modules.union(anmmrp.conf.server_wide_modules)
        if tools.config['test_enable'] and anmmrp.modules.module.current_test:
            installed.add(anmmrp.modules.module.current_test)
