...
from anmmrp import api, models, _
from anmmrp.exceptions import AccessError, RedirectWarning, UserError
from anmmrp.tools import ustr
...
class ResConfigSettings(models.TransientModel, ResConfigModuleInstallationMixin):
    ...
    def get_config_warning(self, msg):
        ...
        Example of use:
        ---------------
        from anmmrp.addons.base.models.res_config import get_warning_config
