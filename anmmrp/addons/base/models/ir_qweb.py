...
QWeb is the primary templating engine used by anmMRP. It is an XML templating
...
<https://www.anmmrp.com/documentation/17.0/developer/reference/frontend/qweb.html>`
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
**Values**: name of the allowed anmmrp user group, or preceded by ``!`` for
prohibited groups

The generated code uses ``user_has_groups`` anmMRP method.
...
from anmmrp import api, models, tools
from anmmrp.modules import registry
from anmmrp.tools import config, safe_eval, pycompat
from anmmrp.tools.constants import SUPPORTED_DEBUGGER, EXTERNAL_ASSET
from anmmrp.tools.safe_eval import assert_valid_codeobj, _BUILTINS, to_opcodes, _EXPR_OPCODES, _BLACKLIST
from anmmrp.tools.json import scriptsafe
from anmmrp.tools.lru import LRU
from anmmrp.tools.misc import str2bool
from anmmrp.tools.image import image_data_uri, FILETYPE_BASE64_MAGICWORD
from anmmrp.http import request
from anmmrp.tools.profiler import QwebTracker
from anmmrp.exceptions import UserError, AccessDenied, AccessError, MissingError, ValidationError

from anmmrp.addons.base.models.assetsbundle import AssetsBundle
from anmmrp.tools.constants import SCRIPT_EXTENSIONS, STYLE_EXTENSIONS, TEMPLATE_EXTENSIONS
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _debug_trace(self, debugger, values):
        ...
        if not debugger:
            ...
            warnings.warn(
                ...
                "since anmMRP 17.0, keep the value empty and configure the "
    ...
    def _link_to_node(self, path, defer_load=False, lazy_load=False, media=None):
        ...
        if is_js:
            ...
            if is_asset_bundle:
                attributes['onerror'] = "__anmmrpAssetError=1"
